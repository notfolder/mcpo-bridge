...
- Slimバリアント採用（イメージサイズ削減）
- Python 3.11以上（最新安定版）

#### 採用イメージ

- ベース：python:3.11-slim
- 代替案：python:3.11-alpine（さらなる軽量化時）
...
- アプリケーションファイル：mcpobridge所有
- 作業ディレクトリ：mcpobridge所有、700パーミッション
- 設定ファイル：読み取り専用マウント
